...
These limitations are release-candidate promises, not a hidden backlog. The public source preview
does not mean the install package has passed its release gate.
