...
This matrix describes the `v0.1.0-alpha.1` release candidate. The package is not public until its
release evidence gate passes. “Supported” means it is part of the intended Community Alpha
contract, not that Stable durability or an SLA is available.
