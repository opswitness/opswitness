...
from opswitness.fsutil import atomic_write as _atomic_write
from opswitness.fsutil import mode_of as _mode_of
from opswitness.fsutil import publish_no_clobber
...
def apply(plist_path: Path, new_bytes: bytes) -> Path:
    ...
    pre-OpsWitness original); the plist write is temp+fsync+rename. Caller
    reloads launchd.
    """
